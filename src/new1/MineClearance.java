...
public class MineClearance {
    static private int midtime = 3600, mineNum = 0, minelevel;
    /* 倒计时时间以及可用旗子数 */
    private static ImageIcon face = new ImageIcon("E:\\face.jpg");
    /* 图标 */
    static private JLabel label1, label2, label3;
    /* 提示文字 */
    ...
    MineClearance() {
        ...
        f.add(label2);
        label3 = new JLabel("关卡:" + minelevel);
        label3.setBounds(400, 40, 120, 20);
        f.add(label3);
        /* 重置按钮 */
...
class GamePanel extends JPanel {
    ...
    private Btn[][] btns;
    private byte[][] click;
    private static ImageIcon flag = new ImageIcon("E:\\flag.jpg");
    private static ImageIcon bomb = new ImageIcon("E:\\bomb.jpg");
